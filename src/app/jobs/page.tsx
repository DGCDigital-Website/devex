...
export const metadata: Metadata = {
  ...
  description: "Join the DGC team. We hire passionate development professionals across East Africa and beyond.",
};
    ...
    <main className="min-h-screen bg-white text-gray-900">
      ...
      <section className="pt-28 pb-16 relative overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-6 sm:px-10">
          <p className="text-dgc-blue-1 text-xs font-semibold tracking-[0.18em] uppercase mb-4">Careers</p>
          ...
          <p className="text-gray-600 text-lg leading-relaxed max-w-2xl">
            We&apos;re always looking for passionate, experienced development professionals to join DGC&apos;s
            growing team across East Africa and beyond.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto px-6 sm:px-10">
          <div className="mb-10">
            ...
            <h2 className="text-gray-900 font-bold text-2xl">
              {JOB_POSTINGS.length} Open Role{JOB_POSTINGS.length !== 1 ? "s" : ""}
            </h2>
          </div>
          ...
          {JOB_POSTINGS.length === 0 ? (
            <div className="text-center py-16 text-gray-400">
              ...
              <p className="text-sm mt-2">
                ...
                <a href="mailto:info@devexglobal.com" className="text-dgc-blue-1 hover:underline">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-6">
                    <div className="space-y-3">
                      <div className="flex flex-wrap items-center gap-3">
                        <h2 className="text-gray-900 font-bold text-lg">{job.title}</h2>
                      ...
                      <div className="flex flex-wrap items-center gap-4 text-gray-500 text-sm">
                        <span className="flex items-center gap-1.5">
                          <MapPin className="w-3.5 h-3.5 text-dgc-blue-1" />{job.location}
                        </span>
                        <span className="flex items-center gap-1.5">
                      ...
                      <div className="pt-1">
                        <p className="text-gray-400 text-xs mb-2 font-medium">Requirements:</p>
                        <ul className="space-y-1.5">
                          {job.requirements.map((req) => (
                            <li key={req} className="text-gray-500 text-sm flex items-start gap-2">
          ...
          <div className="mt-10 p-8 rounded-2xl bg-blue-50/50 border border-dgc-blue-1/15 text-center">
            <h3 className="text-gray-900 font-semibold text-lg mb-2">Don&apos;t see a suitable opening?</h3>
            <p className="text-gray-500 text-sm mb-5">
              We welcome spontaneous applications from experienced development professionals.
